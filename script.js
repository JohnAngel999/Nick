...
function clickheart1(e) {
  if(e.target == heart1) {
    ...
    text1.innerHTML = 'I like your kind heart and soul.';
...
function clickheart2(e) {
  if(e.target == heart2) {
    ...
    text2.innerHTML = 'I like that youre selfless';
    setTimeout(function touchHere() {
...
function clickheart3(e) {
  if(e.target == heart3) {
    ...
    text3.innerHTML = 'I admire your perseverance.';
    setTimeout(function touchHere() {
...
function clickheart4(e) {
  if(e.target == heart4) {
    ...
    text4.innerHTML = 'I like your pretty eyes and gorgeous smile.';
    setTimeout(function touchHere() {
...
function clickheart5(e) {
  if(e.target == heart5) {
    ...
    text5.innerHTML = 'I like that ass.';
    setTimeout(function touchHere() {
